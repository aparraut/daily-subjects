export function getUIRefs(){
  return {
    ...
    metricsPeriod: document.getElementById("metricsPeriod"),
    metricsFrom: document.getElementById("metricsFrom"),
    metricsTo: document.getElementById("metricsTo"),
    metricsSubject: document.getElementById("metricsSubject"),
    ...
    kpiBestSubject: document.getElementById("kpiBestSubject"),
